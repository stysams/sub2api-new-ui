export default {
  ...
  nav: {
    ...
    uiThemeOriginal: 'Original',
    uiThemeSimple: 'Simple',
    uiThemeCustom: 'Custom',
    customBackgroundTitle: 'Custom website background',
    customBackgroundDescription: 'Choose an image for the entire website background and adjust its opacity.',
    customBackgroundChooseImage: 'Choose image',
    customBackgroundReplaceImage: 'Replace image',
    customBackgroundOpacity: 'Background opacity',
    customBackgroundClear: 'Clear background',
    customBackgroundApply: 'Apply background',
    customBackgroundNoImage: 'No image selected',
    customBackgroundInvalidImage: 'Please choose an image file.',
    customBackgroundVisibility: 'Background display',
    customBackgroundOn: 'On',
    customBackgroundOff: 'Off',
    customBackgroundComponentEffect: 'Component effect',
    customBackgroundEffectFrosted: 'Frosted glass',
    customBackgroundEffectTransparent: 'Transparent components',
  ...
  quickChat: {
    ...
    title: 'Quick Chat',
    description: 'Choose an API key and one of its available models to start a conversation.',
    keyLabel: 'API key',
    keyPlaceholder: 'Select an API key',
    keyHint: 'Requests go through the gateway with the selected key and count toward its usage.',
    modelLabel: 'Model',
    modelPlaceholder: 'Select a model',
    modelHint: 'Models come from the selected key\'s current group permissions.',
    modelsLoading: 'Loading models...',
    reasoningLabel: 'Reasoning effort',
    reasoningPlaceholder: 'Use model default',
    reasoningHint: 'Leave blank to use the model or group default.',
    reasoningAuto: 'Auto / default',
    reasoningLow: 'Low',
    ...
    emptyDescription: 'Choose a key and model, then enter a message below.',
    inputLabel: 'Message',
    inputPlaceholder: 'Type a message and press Enter to send',
    securityNote: 'Your browser sends the selected API key to the Sub2API gateway. Do not use shared keys on public devices.',
    clear: 'Clear chat',
    stop: 'Stop generation',
    send: 'Send',
    keysLoadFailed: 'Could not load API keys. Refresh and try again.',
    noKeys: 'There are no active API keys available for quick chat.',
    modelsLoadFailed: 'Could not load models. Check the key status.',
    noModels: 'No models are available for this key.',
    emptyResponse: 'The gateway returned an empty response.',
    sendFailed: 'Message failed to send. Try again later.'
  },
