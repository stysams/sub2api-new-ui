export default {
  ...
  nav: {
    ...
    uiThemeSimple: '简约',
    uiThemeCustom: '自定义',
    customBackgroundTitle: '自定义网站背景',
    customBackgroundDescription: '选择一张图片作为整个网站的背景，并调整显示透明度。',
    customBackgroundChooseImage: '选择图片',
    customBackgroundReplaceImage: '更换图片',
    customBackgroundOpacity: '背景透明度',
    customBackgroundClear: '清除背景',
    customBackgroundApply: '应用背景',
    customBackgroundNoImage: '尚未选择图片',
    customBackgroundInvalidImage: '请选择图片文件。',
    customBackgroundVisibility: '背景显示',
    customBackgroundOn: '已开启',
    customBackgroundOff: '已关闭',
    customBackgroundComponentEffect: '组件效果',
    customBackgroundEffectFrosted: '磨砂玻璃',
    customBackgroundEffectTransparent: '组件透明',
    subscriptions: '订阅管理',
    accounts: '账号管理',
    upstreams: '上游管理',
    plugins: '插件管理',
  ...
  quickChat: {
    eyebrow: '模型快速体验',
    title: '快速体验',
    description: '选择一个 API 密钥和该密钥可用的模型，立即开始对话。',
    keyLabel: 'API 密钥',
    keyPlaceholder: '请选择 API 密钥',
    keyHint: '请求将直接通过所选密钥进入网关，并计入该密钥的用量。',
    modelLabel: '模型',
    modelPlaceholder: '请选择模型',
    modelHint: '模型列表来自所选密钥当前可用的分组权限。',
    modelsLoading: '正在读取模型列表…',
    reasoningLabel: '思考推理等级',
    reasoningPlaceholder: '跟随模型默认',
    reasoningHint: '请合理选择，不支持的可能报错。',
    reasoningAuto: '自动 / 默认',
    reasoningLow: '低',
    reasoningMedium: '中',
    reasoningHigh: '高',
    ...
    assistant: '助手',
    emptyTitle: '准备开始对话',
    emptyDescription: '选择密钥和模型后，在下方输入问题即可开始。',
    inputLabel: '消息内容',
    inputPlaceholder: '输入消息，按 Enter 发送',
    securityNote: '浏览器会携带所选 API 密钥请求本站点的网关。请勿在公共设备上使用共享密钥。',
    clear: '清空对话',
    stop: '停止生成',
    send: '发送',
    keysLoadFailed: 'API 密钥加载失败，请刷新后重试。',
    noKeys: '当前没有可用于快速体验的有效 API 密钥。',
    modelsLoadFailed: '模型列表加载失败，请检查密钥状态。',
    noModels: '该密钥当前没有可用模型。',
    emptyResponse: '网关没有返回响应内容。',
