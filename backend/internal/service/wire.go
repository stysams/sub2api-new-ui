...
// ProvideAdminUpstreamService gives Wire an explicit dependency list for the
// optional dependencies accepted by NewAdminUpstreamService.
func ProvideAdminUpstreamService(
	...
	return NewAdminUpstreamService(repo, admin, encryptor, cfg, settingRepo, emailService)
}
